...
Now, let’s analyze the plot a bit. As we can see, the “No paid” category (Payment_type variable) is the one farthest from the center of the plot. The farther from the center of gravity, the more rarely this feature value appears in the sample represented by the dimensions.
```{r}
...
summary(df[,c(3:10, 12:13, 15, 18, 20:22)])
res.mca_all <- MCA(
  df[,c(1:32)], 
