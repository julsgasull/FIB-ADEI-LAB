...
First we get the proportion of variances retained by the different dimensions (axes).
```{r}
eig.val <- get_eigenvalue(res.mca)
head(eig.val)
```

Now, we visualize the percentages of inertia explained by each MCA dimensions:
```{r}
...
fviz_mca_ind(res.mca, 
             ...
             habillage = "VendorID", # color by groups 
             palette = c("#00AFBB", "#E7B800"),
             addEllipses = TRUE, ellipse.type = "confidence",
             ggtheme = theme_minimal()) 
fviz_mca_ind(res.mca, 
             label = "none", # hide individual labels
             habillage = "RateCodeID", # color by groups 
             palette = c("#00AFBB", "#E7B800"),
             addEllipses = TRUE, ellipse.type = "confidence",
             ggtheme = theme_minimal()) 
fviz_mca_ind(res.mca, 
             label = "none", # hide individual labels
             habillage = "Trip_type", # color by groups 
             palette = c("#00AFBB", "#E7B800"),
             addEllipses = TRUE, ellipse.type = "confidence",
             ggtheme = theme_minimal())
fviz_mca_ind(res.mca, 
             label = "none", # hide individual labels
             habillage = "TipIsGiven", # color by groups 
             palette = c("#00AFBB", "#E7B800"),
             addEllipses = TRUE, ellipse.type = "confidence",
             ggtheme = theme_minimal())
```
