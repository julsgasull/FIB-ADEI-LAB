...
variables that affect more to the clustering are **Trip_distance_range**, **paidTolls** and  because are the one with the
smallest p.value. The variables associated to the clusters are the ones that appear on the output.
Next, we want to see for each cluster which are the categories that characterize them.The clusters that contain
more individuals are the first, the second and the fourth one. Cluster number 4 has less individuals. We proceed
to analyze them.
...
# # Total_amount      17.328080       19.3954753  13.92640493     3.88246513 10.04487145 2.888095e-67
# # 
# # $`2`
# #                     v.test Mean in category Overall mean sd in category  Overall sd       p.value
# # Total_amount     29.183431       26.5066872   13.9264049     9.88546826 10.04487145 3.147246e-187
# # 
# # $`3`
# #                       v.test Mean in category Overall mean sd in category  Overall sd      p.value
# # Total_amount      -12.119349       10.1373934  13.92640493     4.45694924 10.04487145 8.341900e-34
# # 
# # $`4`
# #                    v.test Mean in category Overall mean sd in category  Overall sd       p.value
# # Total_amount     39.12185        51.124128  13.92640493    18.90835873 10.04487145  0.000000e+00
# # 
# # $`5`
# #                       v.test Mean in category Overall mean sd in category  Overall sd       p.value
# # Total_amount      -33.723082        9.0324649  13.92640493     3.54907115 10.04487145 2.653016e-249
```
...
# # TipIsGiven=No                  43.6502429  65.18134715 62.340472  7.289207e-04   3.378464
# # TipIsGiven=Yes                 38.5985066  34.81865285 37.659528  7.289207e-04  -3.378464
# #
# # $`2`
# #                                  Cla/Mod   Mod/Cla    Global       p.value     v.test
# # TipIsGiven=No                  38.965996 68.727050 62.340472  2.645583e-11   6.665059
# # TipIsGiven=Yes                 29.350948 31.272950 37.659528  2.645583e-11  -6.665059
# # 
# # $`3`
# #                             Cla/Mod    Mod/Cla    Global      p.value    v.test
# # nothing to see here
...
# # $`4`
# #                                   Cla/Mod   Mod/Cla    Global      p.value     v.test
# # TipIsGiven=Yes                 24.6984492 56.728232 37.659528 2.002989e-31  11.661577
# # TipIsGiven=No                  11.3809854 43.271768 62.340472 2.002989e-31 -11.661577
# # 
# # $`5`
# #                                   Cla/Mod   Mod/Cla    Global      p.value    v.test
# # TipIsGiven=Yes                 1.60827111 71.794872 37.659528 1.783365e-05  4.290419
# # TipIsGiven=No                  0.38167939 28.205128 62.340472 1.783365e-05 -4.290419
```
...
# # $`1`
# #                                   Cla/Mod    Mod/Cla    Global       p.value    v.test
# # TipIsGiven=Yes                  23.721999 49.6991576 37.659528  5.633107e-15  7.811903
# # TipIsGiven=No                   14.503817 50.3008424 62.340472  5.633107e-15 -7.811903
# # 
# # $`2`
# #                                    Cla/Mod    Mod/Cla    Global       p.value     v.test
# # TipIsGiven=Yes                  15.6232051 55.9670782 37.659528  5.218460e-18   8.648492
# # TipIsGiven=No                    7.4253990 44.0329218 62.340472  5.218460e-18  -8.648492
# # 
# # $`3`
# #                                    Cla/Mod     Mod/Cla     Global       p.value     v.test
# # TipIsGiven=No                   19.5697432  66.8246445 62.3404716  2.794274e-03   2.989508
# # TipIsGiven=Yes                  16.0827111  33.1753555 37.6595284  2.794274e-03  -2.989508
# # 
# # $`4`
# #                                     Cla/Mod    Mod/Cla     Global      p.value     v.test
# # TipIsGiven=Yes                    3.9058013 62.3853211 37.6595284 1.424189e-07   5.262100
# # TipIsGiven=No                     1.4226232 37.6146789 62.3404716 1.424189e-07  -5.262100
# # 
# # $`5`
# #                                   Cla/Mod     Mod/Cla     Global       p.value     v.test
# # TipIsGiven=No                   57.078418  69.9107522 62.3404716  2.371984e-27  10.834134
# # TipIsGiven=Yes                  40.666284  30.0892478 37.6595284  2.371984e-27 -10.834134 
```
...
# # $`1`
# #                                Cla/Mod   Mod/Cla     Global      p.value    v.test
# # TipIsGiven=No                1.0409438 100.00000 62.3404716 6.580800e-07  4.973343
# # TipIsGiven=Yes               0.0000000   0.00000 37.6595284 6.580800e-07 -4.973343
# # 
# # $`2`
# #                                  Cla/Mod     Mod/Cla     Global       p.value     v.test
# # nothing to see here
...
# # $`3`
# #                                  Cla/Mod     Mod/Cla     Global       p.value     v.test
# # TipIsGiven=No                  32.616239  65.5966504 62.3404716  2.137595e-03   3.070418
# # TipIsGiven=Yes                 28.317059  34.4033496 37.6595284  2.137595e-03  -3.070418
# # 
# # $`4`
# #                                  Cla/Mod     Mod/Cla     Global       p.value     v.test
# # TipIsGiven=Yes                 46.984492  41.9057377 37.6595284  3.681425e-07   5.084734
# # TipIsGiven=No                  39.347675  58.0942623 62.3404716  3.681425e-07  -5.084734
# # 
# # $`5`
# #                                     Cla/Mod    Mod/Cla    Global       p.value     v.test
# # TipIsGiven=No                    3.33102012 80.0000000 62.340472  2.655335e-05   4.201175
# # TipIsGiven=Yes                   1.37851809 20.0000000 37.659528  2.655335e-05  -4.201175
```
