...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[10] + jouts[10]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[11] + jouts[11]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[6] + jouts[6]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[7] + jouts[7]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[8] + jouts[8]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[9] + jouts[9]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[12] + jouts[12]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[13] + jouts[13]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[14] + jouts[14]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[18] + jouts[18]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[15] + jouts[15]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[16] + jouts[16]) / 5000; rank
```
...
# rank variables according the sum of missing values (and errors).
rank <- (jerrs[19] + jouts[19]) / 5000; rank
```
