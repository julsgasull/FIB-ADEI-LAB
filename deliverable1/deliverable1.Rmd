...
# !!!!!!! falta espeed
# falta posar passanger count numèric (10) !!!
EL QUE TENIM NOSALTRES (PER ARA)
```{r}
...
# quantile(SwissLabor$age,seq(0,1,0.1),na.rm=T) round(quantile(res.input$completeObs[,2],seq(0,1,0.1),na.rm=T),dig=1)
```


## Categorical variables / Factors
# !!!!!!! Passenger_count ha de ser categorica!!
```{r}
...
# # HOLA QUIERO MORIR NO FUNCIONA NADA
```
...
We will now proceed to the profiling that asks us for our numeric target (INSERT CARD) and then we have to use the original variables and factors.
...
```{r}
# library(mvoutlier)
# no puc seguir sense lo de dalt
# FUCK MY LIFE 
```
